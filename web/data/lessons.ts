...
const gsLessons: Lesson[] = [
  ...
  { slug: "gs-33-authority-intent", courseId: "GAMESERVER", title: "Authority: client gửi ý định, không gửi kết quả", shortTitle: "Intent vs result", chapter: "gs-ch8", order: 33, available: true,
  ...
  { slug: "gs-34-cheat-taxonomy", courseId: "GAMESERVER", title: "Phân loại cheat & phòng thủ server-side", shortTitle: "Phân loại cheat", chapter: "gs-ch8", order: 34, available: true,
  ...
  { slug: "gs-35-anticheat-detection", courseId: "GAMESERVER", title: "Phát hiện gian lận & vận hành", shortTitle: "Phát hiện & vận hành", chapter: "gs-ch8", order: 35, available: true,
