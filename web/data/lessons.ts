...
const gsLessons: Lesson[] = [
  ...
  { slug: "gs-09-why-determinism", courseId: "GAMESERVER", title: "Determinism dùng để làm gì", shortTitle: "Vì sao determinism", chapter: "gs-ch3", order: 9, available: true,
  ...
  { slug: "gs-10-determinism-killers", courseId: "GAMESERVER", title: "Những kẻ giết determinism", shortTitle: "Kẻ giết determinism", chapter: "gs-ch3", order: 10, available: true,
  ...
  { slug: "gs-11-fixed-point", courseId: "GAMESERVER", title: "Fixed-point & simulation tất định tuyệt đối", shortTitle: "Fixed-point", chapter: "gs-ch3", order: 11, available: true,
