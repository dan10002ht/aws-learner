...
const dstLessons: Lesson[] = [
  ...
  { slug: "dst-20-index-ops-scale", courseId: "DATASTORES", title: "Index ở production: build IO, bloat & maintenance", shortTitle: "Index Ops at Scale", chapter: "dst-ch7", order: 21, available: false,
  ...
  { slug: "dst-21-storage-reclamation", courseId: "DATASTORES", title: "Storage reclamation & compaction (VACUUM, LSM)", shortTitle: "Vacuum & Compaction", chapter: "dst-ch7", order: 22, available: false,
  ...
  { slug: "dst-22-replication-lag-ops", courseId: "DATASTORES", title: "Replication lag thực chiến & read-replica pitfalls", shortTitle: "Replication Lag Ops", chapter: "dst-ch7", order: 23, available: false,
  ...
  { slug: "dst-23-connection-pool-scale", courseId: "DATASTORES", title: "Connection pool exhaustion & pooler (PgBouncer)", shortTitle: "Connection Pooling", chapter: "dst-ch7", order: 24, available: false,
  ...
  { slug: "dst-24-hotspot-noisy-neighbor", courseId: "DATASTORES", title: "Hot key, hot partition & noisy neighbor ở scale", shortTitle: "Hotspot & Skew", chapter: "dst-ch7", order: 25, available: false,
  ...
  { slug: "dst-cap-data-incident", courseId: "DATASTORES", title: "Capstone: Chẩn đoán một sự cố data-layer thực chiến", shortTitle: "Capstone: Data Incident", chapter: "dst-ch7", order: 26, available: false,
