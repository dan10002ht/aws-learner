...
const dsLessons: Lesson[] = [
  ...
  { slug: "ds-02-system-models", courseId: "DISTRIBUTED", title: "Mô hình hệ thống & mô hình lỗi", shortTitle: "System & Failure Models", chapter: "dist-ch1", order: 2, available: false,
  ...
  { slug: "ds-03-rpc-networking", courseId: "DISTRIBUTED", title: "Giao tiếp: RPC, network partition & message anomalies", shortTitle: "RPC & Network", chapter: "dist-ch1", order: 3, available: false,
  ...
  { slug: "ds-04-cap-pacelc", courseId: "DISTRIBUTED", title: "CAP theorem & PACELC", shortTitle: "CAP & PACELC", chapter: "dist-ch2", order: 4, available: false,
  ...
  { slug: "ds-05-consistency-models", courseId: "DISTRIBUTED", title: "Consistency models: từ linearizability tới eventual", shortTitle: "Consistency Models", chapter: "dist-ch2", order: 5, available: false,
  ...
  { slug: "ds-06-isolation-vs-consistency", courseId: "DISTRIBUTED", title: "Isolation levels (ACID) vs distributed consistency", shortTitle: "Isolation vs Consistency", chapter: "dist-ch2", order: 6, available: false,
  ...
  { slug: "ds-07-replication-leader", courseId: "DISTRIBUTED", title: "Replication: leader-follower", shortTitle: "Leader-Follower", chapter: "dist-ch3", order: 7, available: false,
  ...
  { slug: "ds-08-multi-leader", courseId: "DISTRIBUTED", title: "Multi-leader & conflict resolution", shortTitle: "Multi-Leader", chapter: "dist-ch3", order: 8, available: false,
  ...
  { slug: "ds-09-quorum", courseId: "DISTRIBUTED", title: "Leaderless & quorum (Dynamo-style)", shortTitle: "Quorum", chapter: "dist-ch3", order: 9, available: false,
  ...
  { slug: "ds-10-partitioning", courseId: "DISTRIBUTED", title: "Partitioning / Sharding", shortTitle: "Partitioning", chapter: "dist-ch4", order: 10, available: false,
  ...
  { slug: "ds-11-consistent-hashing", courseId: "DISTRIBUTED", title: "Consistent hashing & virtual nodes", shortTitle: "Consistent Hashing", chapter: "dist-ch4", order: 11, available: false,
  ...
  { slug: "ds-12-rebalancing-routing", courseId: "DISTRIBUTED", title: "Rebalancing & request routing", shortTitle: "Rebalancing & Routing", chapter: "dist-ch4", order: 12, available: false,
  ...
  { slug: "ds-13-consensus-flp", courseId: "DISTRIBUTED", title: "Bài toán consensus & FLP impossibility", shortTitle: "Consensus & FLP", chapter: "dist-ch5", order: 13, available: false,
  ...
  { slug: "ds-14-raft", courseId: "DISTRIBUTED", title: "Raft: leader election & log replication", shortTitle: "Raft", chapter: "dist-ch5", order: 14, available: false,
  ...
  { slug: "ds-15-coordination", courseId: "DISTRIBUTED", title: "Paxos ý niệm & coordination (ZooKeeper/etcd)", shortTitle: "Coordination", chapter: "dist-ch5", order: 15, available: false,
  ...
  { slug: "ds-16-clocks", courseId: "DISTRIBUTED", title: "Đồng hồ vật lý, NTP & Lamport clock", shortTitle: "Clocks", chapter: "dist-ch6", order: 16, available: false,
  ...
  { slug: "ds-17-vector-clocks", courseId: "DISTRIBUTED", title: "Vector clock & causal ordering", shortTitle: "Vector Clocks", chapter: "dist-ch6", order: 17, available: false,
  ...
  { slug: "ds-18-ordering-broadcast", courseId: "DISTRIBUTED", title: "Ordering & total order broadcast", shortTitle: "Ordering & Broadcast", chapter: "dist-ch6", order: 18, available: false,
  ...
  { slug: "ds-19-distributed-txn", courseId: "DISTRIBUTED", title: "Distributed transaction: 2PC & 3PC", shortTitle: "Distributed Txn", chapter: "dist-ch7", order: 19, available: false,
  ...
  { slug: "ds-20-saga", courseId: "DISTRIBUTED", title: "Saga pattern & compensation", shortTitle: "Saga", chapter: "dist-ch7", order: 20, available: false,
  ...
  { slug: "ds-21-idempotency", courseId: "DISTRIBUTED", title: "Idempotency, dedup & exactly-once", shortTitle: "Idempotency", chapter: "dist-ch7", order: 21, available: false,
  ...
  { slug: "ds-22-reliability-patterns", courseId: "DISTRIBUTED", title: "Reliability patterns: timeout, retry, circuit breaker, backpressure", shortTitle: "Reliability Patterns", chapter: "dist-ch7", order: 22, available: false,
  ...
  { slug: "ds-cap-kvstore", courseId: "DISTRIBUTED", title: "Capstone: Thiết kế một distributed KV store", shortTitle: "Capstone: KV Store", chapter: "dist-ch7", order: 23, available: false,
