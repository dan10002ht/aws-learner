...
const cnLessons: Lesson[] = [
  ...
  { slug: "cn-02-k8s-architecture", courseId: "CLOUDNATIVE", title: "Kiến trúc Kubernetes: control plane & node", shortTitle: "K8s Architecture", chapter: "cn-ch1", order: 2, available: false,
  ...
  { slug: "cn-03-kubectl-objects", courseId: "CLOUDNATIVE", title: "kubectl, YAML declarative & object model", shortTitle: "kubectl & Objects", chapter: "cn-ch1", order: 3, available: false,
  ...
  { slug: "cn-04-pods", courseId: "CLOUDNATIVE", title: "Pod: đơn vị chạy nhỏ nhất & health probes", shortTitle: "Pods", chapter: "cn-ch2", order: 4, available: false,
  ...
  { slug: "cn-05-deployments", courseId: "CLOUDNATIVE", title: "Deployment, ReplicaSet, rolling update & rollback", shortTitle: "Deployments", chapter: "cn-ch2", order: 5, available: false,
  ...
  { slug: "cn-06-statefulset-daemonset-jobs", courseId: "CLOUDNATIVE", title: "StatefulSet, DaemonSet, Job & CronJob", shortTitle: "StatefulSet & Jobs", chapter: "cn-ch2", order: 6, available: false,
  ...
  { slug: "cn-07-services", courseId: "CLOUDNATIVE", title: "Service: ClusterIP, NodePort, LoadBalancer & DNS", shortTitle: "Services", chapter: "cn-ch3", order: 7, available: false,
  ...
  { slug: "cn-08-ingress", courseId: "CLOUDNATIVE", title: "Ingress, Ingress Controller & Gateway API", shortTitle: "Ingress", chapter: "cn-ch3", order: 8, available: false,
  ...
  { slug: "cn-09-config-secret", courseId: "CLOUDNATIVE", title: "ConfigMap, Secret & cấu hình ứng dụng", shortTitle: "ConfigMap & Secret", chapter: "cn-ch3", order: 9, available: false,
  ...
  { slug: "cn-10-storage", courseId: "CLOUDNATIVE", title: "Storage: Volume, PV/PVC, StorageClass & CSI", shortTitle: "Storage", chapter: "cn-ch4", order: 10, available: false,
  ...
  { slug: "cn-11-scheduling", courseId: "CLOUDNATIVE", title: "Scheduling & Autoscaling: requests/limits, affinity, HPA", shortTitle: "Scheduling & Autoscale", chapter: "cn-ch4", order: 11, available: false,
  ...
  { slug: "cn-12-rbac-security", courseId: "CLOUDNATIVE", title: "Security: RBAC, ServiceAccount, Network Policy, Pod Security", shortTitle: "K8s Security", chapter: "cn-ch5", order: 12, available: false,
  ...
  { slug: "cn-13-observability-troubleshoot", courseId: "CLOUDNATIVE", title: "Observability & troubleshooting cluster thực chiến", shortTitle: "Troubleshooting", chapter: "cn-ch5", order: 13, available: false,
  ...
  { slug: "cn-14-helm", courseId: "CLOUDNATIVE", title: "Helm: đóng gói & quản lý ứng dụng k8s", shortTitle: "Helm", chapter: "cn-ch6", order: 14, available: false,
  ...
  { slug: "cn-15-operators", courseId: "CLOUDNATIVE", title: "Operators & CRD: mở rộng Kubernetes", shortTitle: "Operators & CRD", chapter: "cn-ch6", order: 15, available: false,
  ...
  { slug: "cn-16-gitops", courseId: "CLOUDNATIVE", title: "GitOps (ArgoCD/Flux) & deployment strategies", shortTitle: "GitOps", chapter: "cn-ch6", order: 16, available: false,
  ...
  { slug: "cn-17-service-mesh", courseId: "CLOUDNATIVE", title: "Service Mesh (Istio/Linkerd): mTLS, traffic, observability", shortTitle: "Service Mesh", chapter: "cn-ch6", order: 17, available: false,
  ...
  { slug: "cn-cap-deploy", courseId: "CLOUDNATIVE", title: "Capstone: Deploy một app production-ready lên K8s", shortTitle: "Capstone: Deploy", chapter: "cn-ch7", order: 18, available: false,
