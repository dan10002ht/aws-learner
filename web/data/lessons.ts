...
const clfLessons: Lesson[] = [
  ...
  { slug: "09-well-architected",      courseId: "CLF-C02", title: "Well-Architected Framework", shortTitle: "Well-Architected",     chapter: "clf-ch8", order: 9, available: true,
  ...
  { slug: "10-migration-caf",         courseId: "CLF-C02", title: "Migration & Cloud Adoption Framework", shortTitle: "Migration & CAF", chapter: "clf-ch8", order: 10, available: true,
    description: "CAF 6 perspectives, 7 R migration strategies, Snow Family, MGN, DMS, SCT, DRS, MAP.",
    file: "clf-c02/10-migration-caf.md" },
  { slug: "11-compute-extended",      courseId: "CLF-C02", title: "Compute Extended",          shortTitle: "Compute Extended",      chapter: "clf-ch3", order: 11, available: true,
  ...
  { slug: "12-storage-extended",      courseId: "CLF-C02", title: "Storage Extended",          shortTitle: "Storage Extended",      chapter: "clf-ch4", order: 12, available: true,
  ...
  { slug: "13-deploy-iac",            courseId: "CLF-C02", title: "Deploy & IaC",              shortTitle: "Deploy & IaC",          chapter: "clf-ch9", order: 13, available: true,
  ...
  { slug: "14-app-integration",       courseId: "CLF-C02", title: "Application Integration",   shortTitle: "App Integration",       chapter: "clf-ch10", order: 14, available: true,
    description: "SNS, SQS, EventBridge, Step Functions, Amazon MQ — pattern decouple.",
    file: "clf-c02/14-app-integration.md" },
  { slug: "15-ai-ml",                 courseId: "CLF-C02", title: "AI/ML Services",            shortTitle: "AI/ML",                 chapter: "clf-ch11", order: 15, available: true,
  ...
  { slug: "16-analytics",             courseId: "CLF-C02", title: "Analytics Services",        shortTitle: "Analytics",             chapter: "clf-ch11", order: 16, available: true,
  ...
  { slug: "17-monitoring-governance", courseId: "CLF-C02", title: "Monitoring & Governance",   shortTitle: "Monitoring",            chapter: "clf-ch12", order: 17, available: true,
  ...
  { slug: "18-security-extended",     courseId: "CLF-C02", title: "Security Extended",         shortTitle: "Security Extended",     chapter: "clf-ch2", order: 18, available: true,
  ...
  { slug: "19-other-services",        courseId: "CLF-C02", title: "Other Services & Support",  shortTitle: "Other Services",        chapter: "clf-ch13", order: 19, available: true,
...
const clfChapters: Chapter[] = [
  ...
  { id: "clf-ch2",  courseId: "CLF-C02", title: "Security & Identity",        lessonSlugs: ["03-iam", "18-security-extended"], category: "security" },
  { id: "clf-ch3",  courseId: "CLF-C02", title: "Compute",                    lessonSlugs: ["04-ec2", "11-compute-extended"],  category: "compute" },
  { id: "clf-ch4",  courseId: "CLF-C02", title: "Storage",                    lessonSlugs: ["05-s3", "12-storage-extended"],   category: "storage" },
  ...
  { id: "clf-ch8",  courseId: "CLF-C02", title: "Well-Architected & Migration", lessonSlugs: ["09-well-architected", "10-migration-caf"], category: "foundation" },
  { id: "clf-ch9",  courseId: "CLF-C02", title: "Deploy & Operations",        lessonSlugs: ["13-deploy-iac"],     category: "foundation" },
  { id: "clf-ch10", courseId: "CLF-C02", title: "Application Integration",    lessonSlugs: ["14-app-integration"], category: "compute" },
  { id: "clf-ch11", courseId: "CLF-C02", title: "AI/ML & Analytics",          lessonSlugs: ["15-ai-ml", "16-analytics"], category: "compute" },
  { id: "clf-ch12", courseId: "CLF-C02", title: "Monitoring & Governance",    lessonSlugs: ["17-monitoring-governance"], category: "foundation" },
  { id: "clf-ch13", courseId: "CLF-C02", title: "Other Services & Support",   lessonSlugs: ["19-other-services"], category: "foundation" },
];
