...
const gsLessons: Lesson[] = [
  ...
  { slug: "gs-05-fixed-timestep", courseId: "GAMESERVER", title: "Fixed timestep: vì sao dt phải là hằng số", shortTitle: "Fixed timestep", chapter: "gs-ch2", order: 5, available: true,
  ...
  { slug: "gs-06-accumulator-spiral", courseId: "GAMESERVER", title: "Accumulator, catch-up & spiral of death", shortTitle: "Accumulator", chapter: "gs-ch2", order: 6, available: true,
  ...
  { slug: "gs-07-clock-scheduling", courseId: "GAMESERVER", title: "Đồng hồ & scheduling: drift, jitter, lateness", shortTitle: "Đồng hồ & drift", chapter: "gs-ch2", order: 7, available: true,
  ...
  { slug: "gs-08-three-rates-budget", courseId: "GAMESERVER", title: "Ba loại nhịp & ngân sách độ trễ", shortTitle: "Ba nhịp & ngân sách", chapter: "gs-ch2", order: 8, available: true,
