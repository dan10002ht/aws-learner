...
export const courses: Course[] = [
  ...
  },
  {
    ...
    level: "Nền tảng",
    description:
      "Lý thuyết nền của mọi hệ phân tán — cái 'vì sao' nằm dưới Kafka, Redis, Kubernetes: CAP/PACELC, consistency models, replication, partitioning & consistent hashing, consensus (Raft), logical clock, distributed transaction, idempotency & reliability patterns.",
    hint: "Xương sống lý thuyết — học trước thì Data/Messaging/K8s đều sáng.",
    durationHours: 30,
    passingScore: 0, examMinutes: 0, examQuestions: 0,
    prerequisites: ["CS"],
    accentColor: "#0ea5e9",
    order: 15, status: "available", kind: "knowledge", category: "systems",
  },
  {
    id: "DATASTORES",
    code: "DATASTORES",
    title: "Data & Caching Systems (Redis, NoSQL, Search, OLAP)",
    shortTitle: "Data & Caching",
    level: "Nền tảng",
    description:
      "Chọn & dùng đúng kho dữ liệu: Redis chuyên sâu (data structures, Streams, cluster, distributed lock, rate limiter), NoSQL (document/wide-column/KV), Search (Elasticsearch), OLAP (ClickHouse), cache strategy & pitfalls, polyglot persistence.",
    hint: "Redis + họ NoSQL + search + analytics — khi nào dùng gì.",
    durationHours: 28,
    passingScore: 0, examMinutes: 0, examQuestions: 0,
    prerequisites: ["DISTRIBUTED"],
    accentColor: "#ef4444",
    order: 16, status: "available", kind: "knowledge", category: "software",
  },
  {
    id: "MESSAGING",
    code: "MESSAGING",
    title: "Messaging & Event Streaming (Kafka, RabbitMQ, Event-Driven)",
    shortTitle: "Messaging & Streaming",
    level: "Nền tảng",
    description:
      "Từ message queue tới event streaming: RabbitMQ/SQS (exchange, routing, DLQ), Kafka chuyên sâu (partition, consumer group, exactly-once, Connect, Streams, Schema Registry), và kiến trúc event-driven (Event Sourcing, CQRS, Saga, Outbox).",
    hint: "MQ và Kafka — cùng tư duy event-driven, chuẩn production.",
    durationHours: 28,
    passingScore: 0, examMinutes: 0, examQuestions: 0,
    prerequisites: ["DISTRIBUTED"],
    accentColor: "#f59e0b",
    order: 17, status: "available", kind: "knowledge", category: "software",
  },
  {
    id: "CLOUDNATIVE",
    code: "CLOUDNATIVE",
    title: "Cloud Native & Kubernetes",
    shortTitle: "Cloud Native & K8s",
    level: "Nền tảng",
    description:
      "Kubernetes từ kiến trúc tới production: control plane & etcd, Pod/Deployment/Service/Ingress, StatefulSet & storage, RBAC & security, autoscaling, Helm, Operators/CRD, GitOps (ArgoCD), Service Mesh (Istio) và troubleshooting cluster thực chiến.",
    hint: "Mở rộng 2 bài k8s hiện có thành course đầy đủ đến production.",
    durationHours: 32,
    passingScore: 0, examMinutes: 0, examQuestions: 0,
